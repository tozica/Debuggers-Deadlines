 ...
 */
class Sekcija extends \App\Models\Entities\Sekcija implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Sekcija' . "\0" . 'idsekcija', '' . "\0" . 'App\\Models\\Entities\\Sekcija' . "\0" . 'ime', '' . "\0" . 'App\\Models\\Entities\\Sekcija' . "\0" . 'idprosekcija', '' . "\0" . 'App\\Models\\Entities\\Sekcija' . "\0" . 'myTasks'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sekcija $proxy) {
    ...
    public function getIdsekcija()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdsekcija();
        }
    ...
    public function setIdprosekcija(\App\Models\Entities\Projekat $idprosekcija = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdprosekcija', [$idprosekcija]);

        return parent::setIdprosekcija($idprosekcija);
    }
    ...
    public function getIdprosekcija()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdprosekcija', []);

        return parent::getIdprosekcija();
    }
