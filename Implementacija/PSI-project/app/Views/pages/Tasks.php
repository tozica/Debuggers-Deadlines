                                    ...
                                    <ul class="list">
                                        ...
                                        foreach ($labels as $label) {
                                            ...
                                            if ($existsLabel == false) {
                                                echo "<form action='User/label' method='post' id='formLabels'>";
                                                ...
                                                echo "<input type='hidden' id='flagDelete' name='deleteFlag'>";
                                                echo "</form>";
                        ...
                        <div id="head">
                            ...
                            if ($flag == 4) {
                                ...
                                for ($i = 0; $i < count($days); $i++) {
                                    ...
                                    echo "<form id='" . $c . "' method='post' action='User/upcomingDays'>";
                                    if ($first)
                                        echo "<li class='nav-item day active' style=' margin-right:50px; width:100%; text-align:center;margin-bottom:25px' id='" . $days[$i] . "' name='" . $c . "'>";
                                    else {
                                        echo "<li class='nav-item day' style=' margin-right:50px; width:100%; text-align:center;margin-bottom:25px' id='" . $days[$i] . "' name='" . $c . "'>";
                                    }
                                    ...
                                    echo "<input type='hidden' name='day' id='dayHide' value='" . $dates[$i] . "'>";
                                    $c++;
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-primary modalSubmit" value="Add">
                ...
                <div class="modal fade" id="premiumModal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-default" type="button" data-dismiss="modal">Close</button>
                                <a href="User/premium"><input type="button" class="btn btn-primary"  value="Upgrade"></a>
                            </div>
                        </div>
                    </div>
                </div> 
