...
<body>
    <form id="form" name="signUpForm" action="<?= site_url("Gost/signUpSubmit") ?>" method="post">
        <div id="header">
            <a href="SignUp.php"><img src="http://localhost/PSI-projekat/images/logo2.jpg" alt=""></a>
            <h2>Sign up</h2>
        </div>
