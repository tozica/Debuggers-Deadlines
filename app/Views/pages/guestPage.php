    ...
    <div class="container">
        ...
        <div class="row">
            <div class="body0 col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="body2 col-lg-6 col-md-12 col-sm-6">
                    <img class="col-lg-6 col-md-12 col-sm-6" src="http://localhost/PSI-project/Implementacija/img/workingdesk.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="otherFeatures col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="flexColumn col-lg-4 col-md-4 col-sm-4">
                    <img src="http://localhost/PSI-project/Implementacija/img/icons8-notification-100.png" alt="">
                    <div class="text">
                ...
                <div class="flexColumn col-lg-4 col-md-4 col-sm-4">
                    <img src="http://localhost/PSI-project/Implementacija/img/icons8-winrar-150.png" alt="">
                    <div class="text">
