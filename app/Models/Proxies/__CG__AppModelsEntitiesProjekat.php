...
class Projekat extends \App\Models\Entities\Projekat implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Projekat' . "\0" . 'idprojekat', '' . "\0" . 'App\\Models\\Entities\\Projekat' . "\0" . 'ime', '' . "\0" . 'App\\Models\\Entities\\Projekat' . "\0" . 'tip', '' . "\0" . 'App\\Models\\Entities\\Projekat' . "\0" . 'arhiviran', '' . "\0" . 'App\\Models\\Entities\\Projekat' . "\0" . 'idkorisnik'];
        }
